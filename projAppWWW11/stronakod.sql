...
(7, 'kontakt', '<h1>kontakt</h1><div id="mail"><a href="mailto:123456@gmail.com"><img id="koperta" src="obrazki/3178158.png" alt="email icon"></a><form action="php/sendmail.php" method="post"><input name="Imie">Podaj swoje imię<br/><input name="mail">Podaj swoj adres e-mail<br/><input name="wiadomosc">napisz wiadomość<br/><input type="submit" name="x6_submit" class="kontakt" value="wyslij"><input type="reset" value="Wyczyść dane"></div>', 1),
