...
//funkcja pomagajaca wyslac maila
function PokazKontakt()
{
    ...
    <div class="PokazKontakt">
        ...
        <div class="formularz">
            <form method="post" name="mail" enctype="multipart/form-data" action="' .
        $_SERVER["REQUEST_URI"] .
        '">
...
//funkcja obslugujaca formularz do wyslania maila
...
//funkcja obslugujaca przypominanie hasla
